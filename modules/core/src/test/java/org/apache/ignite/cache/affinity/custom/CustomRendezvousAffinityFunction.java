 ...
 * </li>
 * <li>
 *      {@code affinityPrimaryFilter} - Optional filter for primary nodes. If provided, then only
 *      nodes that pass this filter will be selected as primary node candidates. Backups will be assigned later from
 *      the resulted subset of nodes.
 * </li>
 * <li>
 ...
 *      or filter by {@code affinityPrimaryFilter} if latter is set.
 * </li>
 * </ul>
 * <p>
 * Cache affinity can be configured for individual caches via {@link CacheConfiguration#getAffinity()} method.
 */
public class CustomRendezvousAffinityFunction implements AffinityFunction, Externalizable {
    /** */
    ...
    /** Optional filter for allowed primary nodes for partition hosting. */
    private AffinityPrimaryFilter affinityPrimaryFilter;
     ...
     */
    public CustomRendezvousAffinityFunction() {
        this(false);
    }
     ...
     *      of each other.
     */
    public CustomRendezvousAffinityFunction(boolean exclNeighbors) {
     ...
     */
    public CustomRendezvousAffinityFunction(boolean exclNeighbors, int parts) {
     ...
     * Note that {@code backupFilter} is ignored if {@code excludeNeighbors} is set to {@code true}.
     */
    public CustomRendezvousAffinityFunction(int parts,
     ...
     */
    private CustomRendezvousAffinityFunction(boolean exclNeighbors, int parts,
    ...
    /**
     * Sets affinity primary filter.
     * @return filter.
     */
    @Nullable public AffinityPrimaryFilter getAffinityPrimaryFilter() {
        return affinityPrimaryFilter;
    }

    /**
     * Gets affinity primary filter.
     * @param affinityPrimaryFilter filter.
     */
    public void setAffinityPrimaryFilter(@Nullable AffinityPrimaryFilter affinityPrimaryFilter) {
        this.affinityPrimaryFilter = affinityPrimaryFilter;
    }
    ...
    @Override public void writeExternal(ObjectOutput out) throws IOException {
        ...
        out.writeObject(affinityPrimaryFilter);
    }
    ...
    @Override public void readExternal(ObjectInput in) throws IOException, ClassNotFoundException {
        ...
        affinityPrimaryFilter = (AffinityPrimaryFilter)in.readObject();
    }
