...
/**
 * ActivityhistoryuseraccountKey definition.
 *
 * Code generated by Apache Ignite Schema Import utility: 04/29/2016.
 */
public class ActivityhistoryuseraccountKey implements Serializable {
    /** */
    ...
    @Override public boolean equals(Object o) {
        ...
        if (!(o instanceof ActivityhistoryuseraccountKey))
            return false;

        ActivityhistoryuseraccountKey that = (ActivityhistoryuseraccountKey)o;
    ...
    @Override public String toString() {
        return "ActivityhistoryuseraccountKey [useraccountId=" + useraccountId +
