...
/**
 * ActivityhistoryKey definition.
 *
 * Code generated by Apache Ignite Schema Import utility: 04/29/2016.
 */
public class ActivityhistoryKey implements Serializable {
    /** */
    ...
    @Override public boolean equals(Object o) {
        ...
        if (!(o instanceof ActivityhistoryKey))
            return false;

        ActivityhistoryKey that = (ActivityhistoryKey)o;
    ...
    @Override public String toString() {
        return "ActivityhistoryKey [activityhistoryId=" + activityhistoryId +
            "]";
    }
}
